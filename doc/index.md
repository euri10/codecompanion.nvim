...
- Cline CLI (`cline_cli`)
- DeepSeek ACP (`deepseek_acp`) - Requires [CodeWhale](https://github.com/Hmbown/CodeWhale) and a DeepSeek API key or CLI-managed auth
